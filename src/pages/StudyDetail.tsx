...
import { CheckCircle, Circle, PlayCircle, Loader2, ChevronLeft, ChevronRight, Highlighter } from 'lucide-react'; // Removido Crown, Frown
...
import { // RE-IMPORTADO: Select components
  Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
...
const StudyDetail = () => {
  ...
  useEffect(() => {
    const fetchStudyData = async () => {
      ...
      try {
        ...
        // Removido: if (!studyData.is_free && !isUserPro) { ... }
  ...
  // Removido: if (showProAccessModal) { ... }
