...
const DailyStudyPage = () => {
  ...
  const [studyContent, setStudyContent] = useState<{ text: string; title: string | null; auxiliar_text: string | null; tags: string[] | null; url_audio: string | null; templateId: string | null } | null>(null); // Adicionado templateId
